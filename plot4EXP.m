...
title(['Convergence Speed A; #EXP ' num2str(idx) '; #' num2str(index) ]);
set(gca,'fontsize',15);
...
title(['Convergence Speed C; #EXP ' num2str(idx) '; #' num2str(index) ]);%RCMstr]);
set(gca,'fontsize',15);
...
legend(l7,l8,l9);
xlabel('#epoch');ylabel('\phi(x^t)-p^*');
title(['Convergence Speed C; #EXP ' num2str(idx) '; #' num2str(index) ]);
set(gca,'fontsize',15);
