%% compare the 4 methods on G2 matrix, which has band structure
% strongly convexity 1E-5
...
load /home/yu/datasets/SuiteSparse/circuit_simulation_problem/cvx/G2_circuit.mat
A=Problem.A;
%%
% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%
...
title('Convergence of CBCD, L-BFGS-B and APGD');
xlabel('#epoch');
ylabel('log(f(x^k)-f^*)');
grid on;
fig = gcf;
...
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_E5_5.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_E5_5.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_E5_5.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    type I , init = 0.0     %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_E5_0.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_E5_0.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_E5_0.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    type I , init = 1.0     %%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_E5_1.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_E5_1.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_E5_1.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');
%% Type II  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fmin=min([cy1',cy2',cy3',f_bfgs',fx']);
%% plot
figure(4),clf,
semilogy(1:size(cy1,1),cy1-fmin,'r','LineWidth',4);
hold on;
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_E5_5.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_E5_5.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_E5_5.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    type II , init = 0.0     %%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_E5_0.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_E5_0.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_E5_0.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    type I , init = 1.0     %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_E5_1.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_E5_1.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_E5_1.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');
