...
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/uNest_E5_5.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/uNest_E5_5.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/uNest_E5_5.mat',...
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/uNest_E5_0.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/uNest_E5_0.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/uNest_E5_0.mat',...
    'f_pdal','cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5','t6');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    type I , init = 1.0     %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/uNest_E5_1.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/uNest_E5_1.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/uNest_E5_1.mat',...
    'f_pdal','cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5','t6');
%% Type II  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/Nest_E5_5.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/Nest_E5_5.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/Nest_E5_5.mat',...
    'f_pdal','cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5','t6');
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    type II , init = 0.0     %%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/Nest_E5_0.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/Nest_E5_0.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/Nest_E5_0.mat',...
    'f_pdal','cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5','t6');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    type I , init = 1.0     %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/Nest_E5_1.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/Nest_E5_1.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/Facebook/Nest_E5_1.mat',...
    'f_pdal','cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5','t6');