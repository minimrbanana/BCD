...
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_5.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_5.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_5.mat',...
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_0.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_0.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_0.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    type I , init = 1.0     %%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_1.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_1.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/uG2_1.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');
%% Type II  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_5.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_5.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_5.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    type II , init = 0.0     %%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_0.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_0.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_0.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    type I , init = 1.0     %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fig.PaperSize = [fig_pos(3) fig_pos(4)];
set(gca,'FontSize',Fsize,'fontweight', 'bold');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_1.png');
saveas(gca,'/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_1.pdf');
save('/home/yu/bcd/BCD/test_scripts/thesis_compare/G2/G2_1.mat',...
    'cy1','cy2','cy3','f_bfgs','fx','fmin','t1','t2','t3','t4','t5');